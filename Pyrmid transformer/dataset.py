...
def test_trans():
    ...
    return trans
def testload(val_batch):
    root="../data"


    val_dataset = datasets.CIFAR100(root, train=False, transform=transforms.ToTensor(), download=True)
    val_dataload=DataLoader(val_dataset,val_batch,shuffle=False)
    return val_dataload
